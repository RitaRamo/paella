...
class ThisXGLMConfig(XGLMConfig):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # self.enc_text_dim=enc_text_dim
        # self.enc_vision_dim=enc_vision_dim
...
class ThisXGLMAttention(XGLMAttention):
    ...
    def __init__(
        ...
        #print("")
        print("self dim before", self.head_dim)

        self.head_dim = int(self.head_dim / self.cross_attention_reduce_factor)
        print("self head dim after", self.head_dim)
...
class ThisXGLMModel(XGLMModel):
    ...
    def __init__(self, config):
        ...
        #self.my_text_projection=nn.Linear(config.enc_text_dim, config.enc_vision_dim, bias=False)
